...
class Application:
    def __init__(self, master):
        ...
        self.left = Frame(master, width=800, height=720, bg='IndianRed1')
        ...
        self.heading = Label(self.left, text="LYFDROPS", font=('arial 40 bold'), fg='black', bg='steelblue')
        self.heading.place(x=0, y=0)
        # patients name
        self.name = Label(self.left, text="Patient's Name", font=('arial 18 bold'), fg='black', bg='IndianRed1')
        self.name.place(x=0, y=100)

        # age
        self.age = Label(self.left, text="Age", font=('arial 18 bold'), fg='black', bg='IndianRed1')
        self.age.place(x=0, y=140)

        # gender
        self.gender = Label(self.left, text="Gender", font=('arial 18 bold'), fg='black', bg='IndianRed1')
        self.gender.place(x=0, y=180)
        #blood group
        self.bloodgroup = Label(self.left, text="Blood Group", font=('arial 18 bold'), fg='black', bg='IndianRed1')
        self.bloodgroup.place(x=0, y=220)

        # location
        self.location = Label(self.left, text="Location", font=('arial 18 bold'), fg='black', bg='IndianRed1')
        self.location.place(x=0, y=260)

        # appointment time
        self.time = Label(self.left, text="Appointment Time", font=('arial 18 bold'), fg='black', bg='IndianRed1')
        self.time.place(x=0, y=300)

        # phone
        self.phone = Label(self.left, text="Phone Number", font=('arial 18 bold'), fg='black', bg='IndianRed1')
        ...
        self.bloodgroup_ent = Entry(self.left, width=30)
        self.bloodgroup_ent.place(x=250, y=230)
    ...
    def add_appointment(self):
        ...
        self.val4 = self.bloodgroup_ent.get()
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '' or self.val4 == '' or self.val5 == '' or self.val6 == '':
            ...
            sql = "INSERT INTO 'appointments' (name, age, gender, bloodgroup, location, scheduled_time, phone) VALUES(?, ?, ?, ?, ?, ?, ?)"
            c.execute(sql, (self.val1, self.val2, self.val3, self.val4, self.val5, self.val6, self.val7))
            conn.commit()
            tkinter.messagebox.showinfo("Success", "Appointment for " +str(self.val1) + " has been confirmed" )
